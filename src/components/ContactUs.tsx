...
const ContactUs = () => {
  ...
  return (
    ...
    viewport={{ once: true }}
    id="contact-us" className="flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 
      ...
      onSubmit={onSubmit} className="grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full">
        ...
        <div>
            ...
            <div className="flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600">
                ...
                <input name="email" type="email" placeholder="Enter your email" className="w-full p-3 text-sm outline-none" 
                required/>
            </div>
        </div>
        ...
        <div className="sm:col-span-2">
            ...
            <textarea name="message" rows={8} placeholder="Enter your message" className="w-full p-3 text-sm outline-none 
            rounded-lg border border-gray-300 dark:border-gray-600" required/>
        </div>
