...
const Footer = ({ theme }: FooterProps) => {
  return (
    ...
    viewport={{ once: true }}
    className="bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40">
      {/* footer top */}
      <div className="flex justify-between lg:items-center max-lg:flex-col gap-10">
        ...
        className="text-gray-600 dark:text-gray-400">
          ...
          <p className="text-sm mt-2 mb-0">The latest news, articles, and resources, sent to your inbox weekly.</p>
      ...
      className="pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap">
        <p>Copyright 2025 @ agency.io - Metro.</p>
